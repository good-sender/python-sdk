...
class SendEmailRequest(BaseModel):
    ...
    SendEmailRequest
    """ # noqa: E501
    emails: List[SendEmail] = Field(description="List of emails to send. Cannot be empty.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emails": [SendEmail.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None
        })
        return _obj
