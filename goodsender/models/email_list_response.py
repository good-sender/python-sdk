...
class EmailListResponse(BaseModel):
    ...
    next_cursor: Optional[StrictStr] = Field(default=None, description="Cursor to retrieve the next page of results. Omitted if there are no more results.", alias="nextCursor")
    __properties: ClassVar[List[str]] = ["emails", "nextCursor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "emails": [EmailAccount.from_dict(_item) for _item in obj["emails"]] if obj.get("emails") is not None else None,
