...
class TestDomainVerification(unittest.TestCase):
    """DomainVerification unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DomainVerification:
        """Test DomainVerification
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DomainVerification`
        """
    ...
    def testDomainVerification(self):
        """Test DomainVerification"""
